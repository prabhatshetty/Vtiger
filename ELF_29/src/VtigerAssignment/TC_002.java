...
public class TC_002 extends BaseTest {
	...
	public void invoice() {
		...
		Assert.assertEquals(abc,espectedstatus,"Status Created is not selected successfully");
		Reporter.log("Status Created is selected successfully",true);
		
		//step 10: Enter the Quantity
		...
		Assert.assertEquals(actualbilladdres,expectedbilladdress,"Address("+actualbilladdres+") is display");
		...
		Assert.assertEquals(actualquantity,expectedquantity,"Quantity("+actualquantity+") is display");
		Reporter.log("Quantity("+actualquantity+") is display",true);
		String actualstatusdata = invoiceinformationn.getStatusdata().getText();
		String expectedstatusdata = "Created";
