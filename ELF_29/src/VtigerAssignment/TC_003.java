...
public class TC_003 extends BaseTest {
	...
	public void invoice()
	{
		...
		Assert.assertEquals(driver.getTitle(),espectedtinvoiceTittle,"Home Page is not Displayed");
		...
		for(String windowId:allgwindoworg) {
			...
			Reporter.log("Organisation Page is displayed");
		}
		...
		Assert.assertEquals(abc,espectedstatus,"Status Approved is not selected successfully");
		Reporter.log("Status Approved is selected successfully",true);
		...
		String expectedstatusdata = "Approved";
