...
public class TC_004 extends BaseTest {
	...
	public void invoice() throws InterruptedException {
		...
		Reporter.log("Invoice page is displayed");
		...
		String espectedstatus="Sent";
		Assert.assertEquals(abc,espectedstatus,"Status Sent is not selected successfully");
		Reporter.log("Status Sent is selected successfully",true);
		...
		String expectedstatusdata = "Sent";
