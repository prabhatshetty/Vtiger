...
public class TC_005 extends BaseTest {
	...
	public void invoice() {
		...
		String espectedstatus="Credit Invoice";
		Assert.assertEquals(abc,espectedstatus,"Status Credit Invoice is not selected successfully");
		Reporter.log("Status Credit Invoice is selected successfully",true);
		...
		String expectedstatusdata = "Credit Invoice";
